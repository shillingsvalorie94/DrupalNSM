   ...
   class element_gva_image{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         $class_array[] = $el_class;
                 ...
                 ob_start();
         ?>
            <div class="widget gsc-image<?php if(count($class_array) > 0) print (' ' . implode(' ', $class_array)) ?>" <?php print $margin ?> <?php print gavias_content_builder_print_animate_aos($animate, $animate_delay) ?>>
