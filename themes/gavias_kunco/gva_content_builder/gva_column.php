...
class element_gva_column{
	...
	public function render_content( $settings = array(), $content = '' ) {
      ...
      switch ($col_lg) {
      	case 1:
      		$default_col_md = 1; $default_col_sm = 2; $default_col_xs = 6;
      		break;
      	case 2: 
      		$default_col_md = 2; $default_col_sm = 4; $default_col_xs = 12;
      		break;
      	case 3: 
      		$default_col_md = 3; $default_col_sm = 6; $default_col_xs = 12;
      		break;
      	case 4: 
      		$default_col_md = 4; $default_col_sm = 4; $default_col_xs = 12;
      		break;
      	case 5: 
      		$default_col_md = 5; $default_col_sm = 5; $default_col_xs = 12;
      		break;
      	case 6: 
      		$default_col_md = 6; $default_col_sm = 12; $default_col_xs = 12;
      		break;
      	case 7: 
      		$default_col_md = 7; $default_col_sm = 7; $default_col_xs = 12;
      		break;
      	case 8: 
      		$default_col_md = 8; $default_col_sm = 8; $default_col_xs = 12;
      		break;
      	case 9: 
      		$default_col_md = 9; $default_col_sm = 9; $default_col_xs = 12;
      		break;
      	case 10: 
      		$default_col_md = 10; $default_col_sm = 10; $default_col_xs = 12;
      		break;
      	case 11: 
      		$default_col_md = 11; $default_col_sm = 12; $default_col_xs = 12;
      		break;
      	case 12: 
      		$default_col_md = 12; $default_col_sm = 12; $default_col_xs = 12;
      		break;
      	default:
      		$default_col_md = 12; $default_col_sm = 12; $default_col_xs = 12;
      		break;
         ...
         ob_start();
         ?>
		<div <?php if($id_column) print 'id="'.$id_column.'"' ?> class="gsc-column <?php print $column_class; ?>">
	      <div class="column-inner <?php print $column_class_inner ?>" <?php echo(($column_style) ? 'style="'.$column_style.'"' : '');  ?>>
	         <div class="column-content-inner">
	           <?php print $content; ?>
	         </div>  
	         <?php if($bg_attachment == 'fixed'){ ?>
	           <div style="background-repeat: <?php print $bg_repeat; ?>;background-position:<?php print $bg_position ?>;" class="<?php print $col_bg_size ?> gva-parallax-inner skrollable skrollable-between" data-bottom-top="top: -60%;" data-top-bottom="top: 0%;"></div>
	         <?php } ?>
	      </div>
	    </div>
