   ...
   class element_gva_quote_text{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         if($color){
          ...
          ob_start();
         ?>
            <div class="widget gsc-quote-text <?php print $el_class ?>" <?php print ($background ? "style=\"background:{$background};\"" : '') ?> <?php print gavias_content_builder_print_animate_aos($animate, $animate_delay) ?>>
