...
if(!class_exists('element_gva_progress')):
   class element_gva_progress{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
         <div class="widget gsc-progress<?php if(count($class_array)) print (' ' . implode(' ', $class_array)) ?>" <?php print gavias_content_builder_print_animate_aos($animate, $animate_delay) ?>>
