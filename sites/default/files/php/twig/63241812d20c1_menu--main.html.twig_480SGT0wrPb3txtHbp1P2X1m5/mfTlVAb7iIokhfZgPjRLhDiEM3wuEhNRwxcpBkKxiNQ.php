...
/* themes/gavias_kunco/templates/navigation/menu--main.html.twig */
class __TwigTemplate_5ce178dfbc58279f87d94ac2cf5a9690761379774b2d0ff5121449b835e0e29f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["class_columns"] ?? null)];
        ...
        ";
                    ...
                    if (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 64), "gva_layout", [], "any", false, false, true, 64) == "menu-block") && (($context["menu_level"] ?? null) == 0))) {
                        ...
                        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_trim_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "gva_block_content", [], "any", false, false, true, 65), 65, $this->source)), "html", null, true);
                        echo "</div>
        ";
                    }
                    // line 66
  ...
  ";
    ...
    {
        return "themes/gavias_kunco/templates/navigation/menu--main.html.twig";
    }
    ...
    {
        return new Source("", "themes/gavias_kunco/templates/navigation/menu--main.html.twig", "C:\\xampp\\htdocs\\Kunco\\themes\\gavias_kunco\\templates\\navigation\\menu--main.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("import" => 23, "macro" => 31, "if" => 33, "for" => 40, "set" => 41);
        static $filters = array("escape" => 35, "join" => 47, "without" => 60, "trim" => 62);
